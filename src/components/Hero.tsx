    ...
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden transition-all duration-500 bg-gradient-to-b from-[#f7f9fb] via-[#f4f7fb] to-[#ffffff] dark:from-gray-900 dark:via-slate-900 dark:to-slate-800">
      ...
      <div className={`container mx-auto px-4 sm:px-6 text-center dark:text-white text-[#1d2d50] relative z-10 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className={`text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-bold mb-6 sm:mb-8 leading-tight transition-all duration-1000 delay-200 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            كتب تصنع{' '}
          ...
          {/* Enhanced Stats with animations - Mobile stack */}
          <div className={`flex flex-col sm:flex-row justify-center items-center space-y-6 sm:space-y-0 sm:space-x-16 sm:space-x-reverse mt-12 sm:mt-20 transition-all duration-1000 delay-800 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            {[
              ...
              <React.Fragment key={index}>
                <div className="text-center group cursor-pointer" style={{animationDelay: stat.delay}}>
                  <div className="text-2xl sm:text-4xl font-bold dark:text-white text-[#1d2d50] mb-2 group-hover:text-orange-400 transition-colors duration-300 group-hover:scale-110 transform">
                    {stat.number}
                  </div>
